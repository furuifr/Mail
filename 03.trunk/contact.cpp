...
Contact::Contact(int id,QString userName, QString linkmanName, QString groupList, QString remarks, QString phoneNum)
    :id(id),userName(userName),linkmanName(linkmanName),groupList(groupList),remarks(remarks),phoneNum(phoneNum)
{

}
Contact::Contact(QString userName, QString linkmanName)
    :userName(userName),linkmanName(linkmanName)
{
